                  ...
                  <div className="w-full">
                    ...
                    <div className="space-y-6">
                      {service.howItWorks.map((step: string, idx: number) => {
                        ...
                        return (
                          <div key={idx} className="bg-light p-8 rounded-3xl border border-navy/5 flex gap-6 items-start">
               ...
               <div className="max-w-4xl mx-auto flex gap-6">
                  ...
                  <div className="w-full">
                    ...
                    <div className="bg-white p-10 md:p-12 rounded-[40px] border-2 border-green/20 shadow-xl relative overflow-hidden">
                      ...
                      <a href="#service-form" className="inline-flex items-center gap-2 bg-navy text-white px-8 py-4 rounded-full font-bold mt-8 hover:bg-green transition-colors">
                  ...
                  <div className="w-full">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      {service.recentWork.map((work: any, idx: number) => (
                        <Link to={work.link} key={idx} className="group block bg-light p-8 rounded-3xl border border-navy/5 hover:border-green/50 transition-all">
             ...
             <div className="container mx-auto px-6">
               <div className="max-w-4xl mx-auto flex gap-6">
                  ...
                  <div className="w-full">
                    ...
                    <div className="bg-white p-8 md:p-10 rounded-3xl border border-navy/5">
...
// And we need to add JSON-LD script for FAQPage
...
// Insert faqSchema above if (!service) return <Navigate />
content = content.replace(`  if (!service) {`, faqSchemaScript + `\n  if (!service) {`);

// Insert the script tag inside <PageWrapper> or at the end of the return statement before </PageWrapper>
