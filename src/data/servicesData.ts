...
export const servicesData = {
  "setup": {
    ...
    faqs: [
      ...
      { q: "Do we need to buy a premium theme?", a: "While free themes work, we highly recommend a premium theme for better conversion features and unique brandingWe can help you choose the best one." },
      { q: "Will our store be mobile-friendly?", a: "Absolutely. Over 70% of traffic comes from mobile devices, so every store we build is rigorously tested on mobile." },
      { q: "Can we manage the store myself after launch?", a: "Yes. Shopify is user-friendly, and we will show you how to manage inventory, fulfill orders, and update products." },
      { q: "Are domain setup and email included?", a: "Yes, we will properly connect your custom domain to Shopify and can advise on setting up professional business email." }
    ],
  ...
  "dropshipping": {
    ...
    faqs: [
      { q: "Which supplier apps do you work with?", a: "We work with DSers, Zendrop, CJ Dropshipping, Spocket, and private agent integrations." },
      { q: "Will the store look like a generic dropshipping site?", a: "No. Our primary goal is to build a brand. We use custom branding, edited images, and trustworthy layouts to hide the 'dropship' feel." },
      { q: "Is shipping calculated automatically?", a: "Yes, we will configure shipping rates based on your supplier's ePacket or express shipping costs." },
      { q: "Can we integrate AliExpress reviews?", a: "AbsolutelyWe integrate apps like Loox or AliReviews to import real photo reviews for social proof." },
      { q: "Do you help with Facebook or TikTok ads?", a: "We focus strictly on the website development and conversion optimization, giving you the best possible foundation for your ads to succeed." }
    ],
  ...
  "migration": {
    ...
    scope: "We provide a 100% secure, zero-data-loss migration to ShopifyWe transfer your entire product catalog, customer database, order history, and blog posts. Most importantly, we implement vital 301 redirects to ensure your organic Google traffic is perfectly preserved. Afterward, we match your old design or build a fresh, upgraded UI on Shopify.",
    deliverables: [
    ...
    faqs: [
      { q: "Will we lose our SEO rankings?", a: "With our strict 301 redirect mapping, your SEO rankings are preserved. Google will seamlessly recognize the new URLs." },
      { q: "Will our website go offline during the move?", a: "No. Your old site remains live while we build the Shopify store on a temporary domain. We only switch over when everything is perfect." },
      { q: "Can you migrate our customer passwords?", a: "For security reasons, passwords cannot be migratedWe will set up an automated email asking customers to reset their passwords on the new site." },
      ...
      { q: "Can our old apps be transferred?", a: "Apps cannot be directly transferredWe will find and configure the best Shopify equivalents for your existing apps." }
    ],
  ...
  "custom": {
    ...
    faqs: [
      { q: "Will your custom code slow down our site?", a: "NoWe write lightweight, optimized code without relying on heavy jQuery frameworks, ensuring fast load times." },
      { q: "Can we still update our theme later?", a: "We design custom sections to be as modular as possible. However, major theme updates may require minor code adjustments." },
      { q: "Can we edit the custom sections myself?", a: "Yes, we build custom sections with fully integrated Shopify Theme Editor blocks so you can change text, images, and colors without coding." },
      { q: "How do you price custom development?", a: "Pricing is based on the complexity and scope of the specific feature. Contact us for an accurate quote." },
      { q: "Do you modify checkout pages?", a: "Checkout modifications are strictly limited by Shopify unless you are on Shopify PlusWe can customize what is permitted." }
    ],
  ...
  "plus": {
    ...
    scope: "We deliver high-level technical solutions for Shopify Plus merchants. This involves customizing checkout using Checkout Extensibility, configuring robust B2B functions, building private custom apps for internal workflows, migrating enterprise data (Magento/Salesforce), and optimizing architecture for maximum performance during flash sales.",
    deliverables: [
    ...
    faqs: [
      { q: "Are you experienced with Checkout Extensibility?", a: "Yes, we build custom checkout UI extensions and functions to replace deprecated checkout.liquid customizations." },
      { q: "Can you migrate a large store to Shopify Plus?", a: "AbsolutelyWe handle massive data migrations from Magento, BigCommerce Enterprise, or Salesforce Commerce Cloud safely." },
      { q: "Do you build custom Shopify Apps?", a: "We build private apps tailored for internal workflow automation using the Shopify Admin API and webhooks." },
      ...
      { q: "Can you help with Shopify Scripts?", a: "Yes, though Shopify is transitioning to Shopify Functions, we can maintain existing scripts or build new Functions for complex discounting logic." }
    ],
  ...
  "bug": {
    ...
    scope: "We provide rapid, priority bug fixing for Shopify storesWe will diagnose the issue—whether it's a CSS layout break, a broken Liquid tag, or a JavaScript app conflict—and deploy a safe fix without interrupting your live traffic. From urgent checkout bugs to minor visual tweaks, your store will operate flawlessly.",
    deliverables: [
    ...
    faqs: [
      { q: "How fast can you fix our issue?", a: "Depending on our current workload, emergency bugs are usually addressed within 24-48 hours." },
      { q: "Do you need access to our live store?", a: "Yes, you will need to grant us a collaborator account with access to Themes and Apps to diagnose the issue." },
      { q: "Will the fix break anything else?", a: "We always test our fixes on an unpublished duplicate theme first to ensure 100% safety before making it live." },
      { q: "Can you fix apps made by third parties?", a: "We can fix conflicts between the app and your theme. If the app's internal server code is broken, we will need to contact the app developer." },
      { q: "How is pricing determined for bugs?", a: "We provide a fixed quote after a preliminary review of the issue, so there are no surprise hourly fees." }
    ],
  ...
  "seo": {
    ...
    faqs: [
      { q: "When will we see results from SEO?", a: "SEO is a long-term strategy. Technical fixes give an immediate boost to crawlability, but ranking improvements typically take 3 to 6 months." },
      { q: "Is this a one-time service or monthly?", a: "Our Technical SEO setup is a one-time service that builds the foundationWe also offer monthly packages for ongoing content optimization." },
      { q: "Will we rank #1 on Google?", a: "No honest developer can guarantee a #1 rankingWe guarantee your site will perfectly adhere to Google's best practices, giving you the highest possible chance to rank." },
      ...
      { q: "Does page speed affect SEO?", a: "Yes, massively. Google penalizes slow sites. Our SEO service includes basic speed optimizations for better Core Web Vitals." }
    ],
  ...
  "cro": {
    ...
    scope: "We use data, not guessworkWe will install heatmap tracking (like Microsoft Clarity or Hotjar) to record real user behaviorWe conduct a comprehensive heuristic UX audit of your layout, identify exactly where the friction is, and redesign those elements. We will implement trust signals, streamline checkout flows, and clarify product messaging to drastically improve your Conversion Rate.",
    deliverables: [
    ...
    faqs: [
      { q: "What is a good conversion rate for Shopify?", a: "The industry average is around 1.5% - 2%. Our goal is to push high-performing stores toward 3% - 5%." },
      { q: "Do we need traffic for a CRO audit to work?", a: "Yes. CRO relies on data. You need a steady stream of traffic (at least a few thousand visitors a month) to gather meaningful heatmap data." },
      { q: "How long does a CRO audit take?", a: "We usually collect data for 1-2 weeks, then take a week to compile the audit and implement the structural changes." },
  ...
  "apps": {
    ...
    scope: "We handle the complex configuration of advanced Shopify apps. Whether you are setting up recurring subscriptions with Recharge, advanced email flows with Klaviyo, or a multi-tiered loyalty program with Yotpo, we integrate them seamlessly into your themeWe ensure the CSS matches your branding perfectly and no app scripts conflict with your store's core functions.",
    deliverables: [
    ...
    faqs: [
      { q: "Can you make an app look like our theme?", a: "Yes, we override the default app CSS to ensure its widgets seamlessly match your site’s fonts, colors, and styling." },
      { q: "Are you an app developer?", a: "We do not build private apps from scratchWe specialize in integrating, configuring, and styling existing high-tier public apps." },
      { q: "Will installing too many apps slow down our store?", a: "Yes, 'app bloat' is a major issueWe ensure we only install what is strictly necessary and defer their scripts to protect page speed." },
      { q: "Can you migrate our data between apps?", a: "Yes, such as moving reviews from Loox to Judge.us, or subscribers from Mailchimp to Klaviyo." },
      { q: "What happens if an app breaks our store?", a: "We always take a theme backup before installing complex apps. If something breaks, we can instantly revert and troubleshoot safely." }
    ],
  ...
  "speed": {
    ...
    scope: "We perform a ruthless technical speed optimization on your Shopify themeWe compress images, implement lazy-loading, defer non-essential JavaScript, preload critical CSS/fonts, and prune leftover code from deleted apps. Your store will achieve significantly higher Google PageSpeed scores and, more importantly, feel instantly responsive to actual users.",
    deliverables: [
    ...
    faqs: [
      { q: "What score will we get on Google PageSpeed Insights?", a: "While we aim for 80+ on Mobile and 90+ on Desktop, real-world load time (under 2.5s) is heavily reliant on the apps you require for your business." },
      { q: "Will optimization change how our site looks?", a: "No. Speed optimization happens 'under the hood'. Your website will look exactly the same, but load much faster." },
      { q: "Do you use an app to do this?", a: "No. Speed apps often break themesWe optimize the code manually for permanent, safe results." },
      { q: "Why is our mobile score so much lower than desktop?", a: "Google simulates a mid-tier mobile device on a slow 3G/4G network. It's much harder to score high on mobile, which is why manual code optimization is critical." },
      { q: "Will speed increase our sales?", a: "Yes. By drastically reducing bounce rates, more customers reach your product pages, directly increasing your opportunity to convert." }
    ],
