...
export const technicalParagraphs = [
...
export const faqsData = [
  {
    "q": "How long does a typical optimization sprint take?",
    "a": "A comprehensive technical sprint typically requires 2-4 weeks, depending on the complexity of your theme and the severity of the accrued technical debt."
  },
  {
    "q": "Will installing a new theme fix my Core Web Vitals?",
    "a": "Not necessarily. While modern OS 2.0 themes are better optimized out-of-the-box, migrating data, apps, and custom logic often reintroduces the same performance bottlenecks."
  },
  {
    "q": "Should I migrate to a headless architecture?",
    "a": "Headless is recommended for stores doing $5M+ annually with complex content modeling requirements or a need for absolute control over the frontend performance ceiling."
  },
  {
    "q": "How often should I audit my Shopify apps?",
    "a": "We recommend a quarterly code audit. Unused apps leave residual JavaScript in your theme.liquid even after they are 'uninstalled' from the admin dashboard."
  },
  {
    "q": "What is the most common cause of slow LCP on Shopify?",
    "a": "The most frequent culprit is unoptimized hero images (lack of correct sizing, format, and explicit fetchpriority) coupled with synchronous JavaScript blocking the critical rendering path."
  }
];
