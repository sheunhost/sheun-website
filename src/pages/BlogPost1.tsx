            ...
            <div className="prose prose-lg md:prose-xl max-w-none prose-headings:font-bold prose-headings:text-navy prose-p:text-navy/80 prose-p:leading-loose font-serif">
              ...
              <div className="bg-navy p-8 rounded-3xl text-white my-12 shadow-2xl font-sans">
                ...
                <button onClick={handleWhatsAppContact} className="bg-green text-navy font-bold px-6 py-3 rounded-full flex items-center gap-2 hover:scale-105 transition-transform shadow-xl">
                  <MessageCircle size={20} /> Get a Free Store Audit
                </button>
              </div>
            ...
            <div className="pt-16 mt-16 border-t border-navy/5 flex flex-col md:flex-row items-start md:items-center justify-between gap-10">
              ...
              <div className="w-full md:w-auto">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  <button onClick={handleTwitterShare} className="w-12 h-12 flex items-center justify-center bg-light border border-navy/10 text-navy rounded-full hover:bg-[#1DA1F2] hover:text-white hover:border-[#1DA1F2] transition-colors shadow-sm focus:outline-none focus:ring-4 focus:ring-[#1DA1F2]/20">
                    <Twitter size={20} />
                  </button>
                  <button onClick={handleFacebookShare} className="w-12 h-12 flex items-center justify-center bg-light border border-navy/10 text-navy rounded-full hover:bg-[#4267B2] hover:text-white hover:border-[#4267B2] transition-colors shadow-sm focus:outline-none focus:ring-4 focus:ring-[#4267B2]/20">
                    <Facebook size={20} />
                  </button>
                  <button onClick={handleLinkedinShare} className="w-12 h-12 flex items-center justify-center bg-light border border-navy/10 text-navy rounded-full hover:bg-[#0077b5] hover:text-white hover:border-[#0077b5] transition-colors shadow-sm focus:outline-none focus:ring-4 focus:ring-[#0077b5]/20">
                    <Linkedin size={20} />
                  </button>
                  <button onClick={handleWhatsAppShare} className="w-12 h-12 flex items-center justify-center bg-light border border-navy/10 text-navy rounded-full hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-colors shadow-sm focus:outline-none focus:ring-4 focus:ring-[#25D366]/20">
                    <Phone size={20} />
                  </button>
                </div>
              </div>
