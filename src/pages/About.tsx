...
export default function About() {
  ...
  return (
    ...
    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-8">
                ...
                <div className="flex flex-wrap gap-4 pt-2">
                  <div className="flex items-center gap-3 bg-[#F8FAFC] border border-[#E2E8F0] px-5 py-3 rounded-2xl text-xs font-bold text-[#0F172A] uppercase tracking-wider shadow-sm">
                ...
                <div className="pt-6 border-t border-[#E2E8F0] space-y-4">
                  <span className="text-xs font-bold uppercase tracking-widest text-[#71717a] block">Direct Connection Channels</span>
              ...
              <div className="lg:col-span-5 relative">
                <div className="relative mx-auto max-w-sm lg:max-w-none">
                  ...
                  <motion.div 
                    ...
                    className="relative z-10 aspect-[4/5] rounded-[36px] overflow-hidden border-[16px] border-white shadow-2xl bg-[#F8FAFC]"
                  >
                    <img 
                  ...
                  <motion.div 
                    ...
                    className="absolute -bottom-8 -right-4 sm:-right-8 bg-white p-6 rounded-3xl shadow-2xl border border-[#E2E8F0] z-20 flex flex-col items-center gap-2 max-w-[170px]"
                  >
                    <div className="w-12 h-12 bg-[#10b981]/10 rounded-2xl flex items-center justify-center text-[#10b981]">
                      <Award size={26} />
                    </div>
                    <div className="text-center">
                      <p className="text-[10px] font-bold uppercase tracking-wider text-[#71717a]">Official</p>
                      <p className="text-base font-extrabold text-[#0F172A] leading-tight">Shopify Partner</p>
                    </div>
                  </motion.div>
                </div>
              </div>
      ...
      <ScrollReveal>
        <section className="py-32 bg-[#F8FAFC] relative overflow-hidden border-b border-[#E2E8F0]">
              ...
              <div className="lg:col-span-6 space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 p-4 bg-white border border-[#E2E8F0] rounded-2xl shadow-sm">
      ...
      <section className="py-8 bg-white border-b border-[#E2E8F0] relative overflow-hidden">
        ...
        <section className="py-32 bg-[#0F172A] relative overflow-hidden text-white">
          ...
          <div className="container mx-auto px-6 max-w-7xl relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-4 bg-[#10b981] p-8 sm:p-12 rounded-[32px] space-y-6 flex flex-col justify-between text-[#0F172A] relative overflow-hidden shadow-xl border border-[#10b981]">
                {/* Dotted mesh decor */}
                ...
                <div className="space-y-4 relative z-10">
                  <div className="w-14 h-14 bg-white/20 rounded-2xl flex items-center justify-center text-[#0F172A]">
                  ...
                  <p className="text-[#0F172A]/80 font-medium text-sm leading-relaxed">
                ...
                <div className="relative z-10 flex -space-x-3 pt-4">
                  {[1, 2, 3, 4, 5].map(i => (
                    <div key={i} className="w-11 h-11 rounded-full border-4 border-[#10b981] bg-white overflow-hidden shadow-sm">
                      <img 
        ...
        <section className="py-32 bg-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 max-w-7xl relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-24 space-y-4">
              ...
              <h2 className="text-5xl md:text-7xl font-bold text-navy tracking-tight">How I <span className="text-[#10b981] italic font-serif font-light">Work</span>.</h2>
              <p className="text-[#71717a] text-lg font-serif italic max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <motion.div 
                  key={i} 
                  whileHover={{ y: -4 }}
                  className="p-8 sm:p-10 bg-white border border-[#E2E8F0] rounded-3xl space-y-8 shadow-[0_2px_8px_rgba(0,0,0,0.01)] hover:shadow-[0_20px_40px_-15px_rgba(9,9,11,0.06)] transition-all flex flex-col justify-between"
                >
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <h3 className="text-2xl font-bold text-[#0F172A] tracking-tight">{card.title}</h3>
                      <p className="text-[#71717a] text-sm leading-relaxed">{card.desc}</p>
                    </div>
                  </div>
                  <div className="pt-4 border-t border-[#E2E8F0] flex items-center gap-2 text-[10px] font-bold text-green uppercase tracking-widest">
