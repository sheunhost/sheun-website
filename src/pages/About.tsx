            ...
            <div className="space-y-16">
              ...
              >
                ...
                <div className="flex gap-4 pt-8 border-t border-navy/5 mt-8 w-fit">
                  ...
                  <a href="https://github.com/sheunhost" target="_blank" rel="noopener noreferrer" className="p-3 bg-navy text-white hover:bg-green hover:text-navy rounded-full transition-all" title="GitHub">
