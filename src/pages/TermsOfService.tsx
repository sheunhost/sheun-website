          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 max-w-6xl mx-auto">
            <div className="md:col-span-4 space-y-8">
              <div className="bg-light dark:bg-white/5 p-8 rounded-2xl sticky top-32 border border-transparent dark:border-white/10">
                <h3 className="text-xl font-bold text-navy dark:text-white mb-6">Agreement Overview</h3>
                <ul className="space-y-4">
                  <li><a href="#acceptance" className="text-navy/60 dark:text-white/60 hover:text-green font-medium transition-colors">1. Acceptance</a></li>
                  <li><a href="#services" className="text-navy/60 dark:text-white/60 hover:text-green font-medium transition-colors">2. Services</a></li>
                  <li><a href="#responsibilities" className="text-navy/60 dark:text-white/60 hover:text-green font-medium transition-colors">3. Responsibilities</a></li>
                  <li><a href="#payments" className="text-navy/60 dark:text-white/60 hover:text-green font-medium transition-colors">4. Payments</a></li>
                  <li><a href="#ip" className="text-navy/60 dark:text-white/60 hover:text-green font-medium transition-colors">5. Intellectual Property</a></li>
                  <li><a href="#liability" className="text-navy/60 dark:text-white/60 hover:text-green font-medium transition-colors">6. Liability</a></li>
                </ul>
              </div>
            </div>
            ...
            <div className="md:col-span-8 space-y-16 text-navy/80 dark:text-white/80">
              <div className="space-y-6" id="acceptance">
                <div className="flex items-center gap-4">
                  ...
                  <h2 className="text-3xl font-bold text-navy dark:text-white">1. Acceptance of Terms</h2>
                </div>
              ...
              <div className="space-y-6" id="services">
                <div className="flex items-center gap-4">
                  ...
                  <h2 className="text-3xl font-bold text-navy dark:text-white">2. Description of Service</h2>
                </div>
                <p className="leading-relaxed text-lg">
              ...
              <div className="space-y-6" id="responsibilities">
                <div className="flex items-center gap-4">
                  <h2 className="text-3xl font-bold text-navy dark:text-white">3. Client Responsibilities</h2>
                </div>
                <p className="leading-relaxed text-lg">
              ...
              <div className="space-y-6" id="payments">
                <div className="flex items-center gap-4">
                  ...
                  <h2 className="text-3xl font-bold text-navy dark:text-white">4. Payment Terms</h2>
                </div>
                <p className="leading-relaxed text-lg">
              ...
              <div className="space-y-6" id="ip">
                <div className="flex items-center gap-4">
                  <h2 className="text-3xl font-bold text-navy dark:text-white">5. Intellectual Property</h2>
                </div>
                <p className="leading-relaxed text-lg">
              ...
              <div className="space-y-6" id="liability">
                <div className="flex items-center gap-4">
                  ...
                  <h2 className="text-3xl font-bold text-navy dark:text-white">6. Limitation of Liability</h2>
                </div>
                <p className="leading-relaxed text-lg">
              ...
              <div className="mt-16 pt-8 border-t border-navy/10 dark:border-white/10 text-center">
                <p className="text-navy/60 dark:text-white/60 italic font-serif">
