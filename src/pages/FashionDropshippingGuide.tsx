    ...
    >
        ...
        <div className="max-w-4xl mx-auto bg-white dark:bg-navy rounded-2xl shadow-2xl p-8 md:p-16 border border-navy/5 dark:border-white/5 space-y-12">
          ...
          <div className="aspect-video bg-light dark:bg-white/5 w-full rounded-3xl overflow-hidden shadow-inner mb-12 relative flex items-center justify-center group">
            ...
            <div className="prose prose-lg md:prose-xl max-w-none prose-headings:font-bold prose-headings:text-navy dark:text-white prose-p:text-navy/80 dark:text-white/80 prose-p:leading-relaxed font-sans">
              ...
              <h2 className="text-3xl font-bold text-navy dark:text-white mt-16 mb-8 font-sans tracking-tight">1. Identifying Your Tribal Niche</h2>
              <p>
              ...
              <div className="bg-light dark:bg-white/5 p-8 rounded-xl my-8 space-y-4">
                <p className="font-sans font-bold text-navy dark:text-white uppercase text-xs tracking-widest">Recommended Sub-Niches for 2026:</p>
                <ul className="list-none grid grid-cols-1 md:grid-cols-2 gap-4 pl-0">
                  <li className="flex items-center gap-3 bg-white dark:bg-navy p-4 rounded-2xl border border-navy/5 dark:border-white/5 shadow-sm">
              ...
              <h2 className="text-3xl font-bold text-navy dark:text-white mt-16 mb-8 font-sans tracking-tight">2. The High-Conversion Architecture</h2>
              <p>
              ...
              <h2 className="text-3xl font-bold text-navy dark:text-white mt-16 mb-8 font-sans tracking-tight">3. Sourcing Strategy: The SRE Framework</h2>
              <p>
              ...
              <h2 className="text-3xl font-bold text-navy dark:text-white mt-16 mb-8 font-sans tracking-tight">4. SEO Cluster Strategy for Fashion</h2>
              <p>
              ...
              <div className="flex items-start gap-4 bg-light dark:bg-white/5 p-8 rounded-xl border-l-8 border-green my-12 font-sans italic">
                <Zap className="text-green shrink-0 mt-1" size={32} />
                <p className="text-lg font-medium text-navy dark:text-white m-0">
              ...
              <h2 className="text-3xl font-bold text-navy dark:text-white mt-16 mb-8 font-sans tracking-tight">5. Marketing: The Content Flywheel</h2>
              <p>
                Fashion is a performance art. You cannot scale on static photos alone.
              </p>
              <ul className="space-y-4 my-8 list-none pl-0">
                <li className="flex gap-4 p-6 bg-light dark:bg-white/5 rounded-2xl border border-navy/5 dark:border-white/5">
                  <div className="w-8 h-8 bg-navy text-white rounded-lg flex items-center justify-center shrink-0 text-xs font-bold">A</div>
                  <div className="text-navy dark:text-white"><strong>TikTok Search Optimization:</strong> Treat TikTok like a search engine. Use keywords in your captions and text-on-screen so you appear in the "Search" bar for your niche.</div>
                </li>
                <li className="flex gap-4 p-6 bg-light dark:bg-white/5 rounded-2xl border border-navy/5 dark:border-white/5">
                  <div className="w-8 h-8 bg-navy text-white rounded-lg flex items-center justify-center shrink-0 text-xs font-bold">B</div>
                  <div className="text-navy dark:text-white"><strong>UGC Whitelisting:</strong> Take videos from your customers (with permission) and run them as "Spark Ads" on TikTok. These outperform professional ads by 300%.</div>
                </li>
              </ul>
            </div>
          ...
          <div className="pt-16 mt-16 border-t border-navy/5 dark:border-white/5">
            ...
            <form onSubmit={handleAddComment} className="bg-white dark:bg-navy p-8 md:p-10 rounded-2xl shadow-2xl border border-navy/5 dark:border-white/5 space-y-6">
              <h4 className="text-xl font-bold text-navy dark:text-white mb-2">Join the Conversation</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2 md:col-span-2">
                  ...
                  <input type="text" required value={commentName} onChange={(e) => setCommentName(e.target.value)} className="w-full bg-light dark:bg-white/5 border-b-2 border-navy/5 dark:border-white/5 hover:border-navy/20 dark:border-white/20 hover:bg-white dark:bg-navy rounded-3xl py-4 px-6 focus:border-green outline-none transition-all font-medium text-navy dark:text-white placeholder:text-navy/20 dark:text-white/20" placeholder="Your Name" />
                </div>
                <div className="space-y-2 md:col-span-2">
                  <label className="text-xs font-bold text-navy/50 dark:text-white/50 uppercase tracking-[0.2em] ml-4">Comment *</label>
      ...
      <section className="container mx-auto px-6 mt-32">
        <div className="text-center mb-16 space-y-4">
          <h3 className="text-4xl font-bold text-navy dark:text-white tracking-tight">Expand Your Knowledge</h3>
          <p className="text-navy/40 dark:text-white/40 font-serif italic text-lg">More strategies and insights for Shopify growth.</p>
        </div>
