  ...
  return (
    ...
    >
      ...
      <section className="pt-32 pb-20 bg-white dark:bg-navy relative overflow-hidden">
        ...
        {/* Ambient Glows */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#6D28D9]/10 rounded-full blur-[140px] pointer-events-none -z-10"></div>
        <div className="absolute bottom-0 left-0 w-[450px] h-[450px] bg-[#FF6B4A]/10 rounded-full blur-[140px] pointer-events-none -z-10"></div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <a
                href="#book"
                className="w-full sm:w-auto px-8 py-5 rounded-2xl bg-gradient-to-r from-[#FF6B4A] via-[#D946EF] to-[#6D28D9] text-white font-bold text-lg hover:opacity-95 hover:scale-105 transition-all shadow-xl shadow-[#D946EF]/25 flex items-center justify-center gap-3 group"
              >
      ...
      <section className="py-24 bg-navy text-white overflow-hidden relative">
        ...
        <div className="absolute top-0 right-0 w-1/3 h-full bg-[#D946EF]/10 blur-[120px] rounded-full pointer-events-none"></div>
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold mb-8">The Deliverable: <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B4A] via-[#D946EF] to-[#8B5CF6]">Actionable Clarity.</span></h2>
              ...
              <div className="space-y-8">
                <div className="flex gap-6">
                  <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center shrink-0">
                    <FileText size={24} className="text-[#FF6B4A]" />
                  </div>
                  <div>
                ...
                <div className="flex gap-6">
                  <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center shrink-0">
                    <Video size={24} className="text-[#D946EF]" />
                  </div>
                  <div>
            ...
            <div className="bg-white/5 border border-white/10 p-8 md:p-12 rounded-[3rem] backdrop-blur-sm relative overflow-hidden">
              {/* Pool Wall Top Rim */}
              ...
              <div className="space-y-6">
                <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                  <span className="text-[#FF6B4A] font-bold text-lg mb-1 block">1. One Sale Covers It</span>
                ...
                <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                  <span className="text-[#D946EF] font-bold text-lg mb-1 block">2. Stop Burning Ad Spend</span>
                ...
                <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                  <span className="text-[#8B5CF6] font-bold text-lg mb-1 block">3. Years of Experience</span>
          ...
          <div className="bg-white dark:bg-white/5 p-12 md:p-20 rounded-[4rem] border border-navy/5 dark:border-white/10 shadow-2xl text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col items-center gap-6">
                <a
                  href="/contact"
                  className="w-full sm:w-auto px-12 py-6 rounded-2xl bg-gradient-to-r from-[#FF6B4A] via-[#D946EF] to-[#6D28D9] text-white font-bold text-xl hover:opacity-95 hover:scale-105 transition-all shadow-2xl shadow-[#D946EF]/30 flex items-center justify-center gap-3"
                >
