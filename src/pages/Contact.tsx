...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <ScrollReveal>
        <section className="py-32 bg-white dark:bg-navy relative" id="contact-form">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-5 space-y-12">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <motion.a
                  ...
                  className="sm:col-span-2 group relative p-10 bg-navy dark:bg-white/5 dark:border dark:border-white/10 text-white rounded-[40px] overflow-hidden shadow-2xl transition-all hover:bg-navy/95 dark:hover:bg-white/10"
                >
                ...
                <motion.a
                  ...
                  className="sm:col-span-2 p-8 bg-light dark:bg-white/5 rounded-[40px] border border-navy/5 dark:border-white/10 hover:border-green/50 transition-all group"
                >
                  <div className="space-y-10">
                    <div className="w-14 h-14 bg-white dark:bg-white/10 rounded-2xl flex items-center justify-center shadow-sm group-hover:bg-green transition-colors overflow-hidden">
                    ...
                    <div className="space-y-2">
                      <p className="text-navy dark:text-white font-bold text-xl uppercase tracking-tighter">LinkedIn</p>
                      <p className="text-navy/40 dark:text-white/60 text-sm font-medium tracking-tight">Professional network & insights.</p>
                    </div>
                  </div>
                </motion.a>
                ...
                <div className="sm:col-span-2 p-10 bg-green rounded-[40px] flex items-center justify-between shadow-xl">
                  <div className="space-y-2">
                    <div className="text-navy dark:text-white font-bold text-2xl tracking-tighter leading-none">Sheun Hub®</div>
                    <p className="text-navy/60 dark:text-white/70 text-xs font-bold uppercase tracking-widest">Shopify Development</p>
                  </div>
                  <div className="w-20 h-20 rounded-full border-4 border-navy/10 dark:border-white/20 flex items-center justify-center">
                    <div className="w-4 h-4 bg-navy dark:bg-white rounded-full animate-ping" />
                  </div>
                </div>
              </div>

              {/* Trust Badge / FAQ Micro */}
              <div className="p-12 space-y-8 bg-light dark:bg-white/5 rounded-[40px] border border-navy/5 dark:border-white/10 border-dashed">
                <h3 className="text-2xl font-bold text-navy dark:text-white tracking-tight">What to expect?</h3>
                <div className="space-y-6">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4 text-navy/70 dark:text-white/70 text-sm font-medium">
            ...
            <div className="lg:col-span-7 bg-white dark:bg-navy">
              <div className="relative group">
                {/* Decorative border gradient */}
                <div className="absolute -inset-[1px] bg-gradient-to-tr from-green/20 via-navy/5 to-white dark:from-green/30 dark:via-white/5 dark:to-transparent rounded-[44px] group-hover:from-green/40 transition-all" />
                
                <div className="relative bg-white dark:bg-navy-light dark:border dark:border-white/10 p-10 md:p-20 rounded-[40px] shadow-2xl">
                    ...
                    {!isSuccess ? (
                      ...
                      >
                        <div className="space-y-6 text-center lg:text-left">
                          <h3 className="text-4xl md:text-5xl font-bold text-navy dark:text-white tracking-tighter leading-none">Start a project.</h3>
                          <p className="text-navy/50 dark:text-white/60 text-xl font-serif italic leading-relaxed">Tell us about your vision, and let's see how we can make it a reality.</p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
                          {/* Name Field */}
                          <div className="space-y-3">
                            <label className="text-xs font-bold text-navy/40 dark:text-white/60 uppercase tracking-widest pl-2 block">Full Name</label>
                            <input
                              type="text"
                              name="name"
                              placeholder="e.g. Jane Doe"
                              className={`w-full bg-light/30 dark:bg-white/5 rounded-2xl py-5 px-6 border-2 focus:border-green hover:border-navy/10 dark:hover:border-white/20 text-navy dark:text-white placeholder:text-navy/20 dark:placeholder:text-white/30 outline-none transition-all focus:bg-white dark:focus:bg-navy focus:shadow-lg focus:-translate-y-1 ${errors.name ? 'border-red-500' : 'border-light dark:border-white/10'}`}
                            />
                          ...
                          {/* Email Field */}
                          <div className="space-y-3">
                            <label className="text-xs font-bold text-navy/40 dark:text-white/60 uppercase tracking-widest pl-2 block">Email Address</label>
                            <input
                              type="email"
                              name="email"
                              placeholder="hello@brand.com"
                              className={`w-full bg-light/30 dark:bg-white/5 rounded-2xl py-5 px-6 border-2 focus:border-green hover:border-navy/10 dark:hover:border-white/20 text-navy dark:text-white placeholder:text-navy/20 dark:placeholder:text-white/30 outline-none transition-all focus:bg-white dark:focus:bg-navy focus:shadow-lg focus:-translate-y-1 ${errors.email ? 'border-red-500' : 'border-light dark:border-white/10'}`}
                            />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
                          {/* Phone Field */}
                          <div className="space-y-3">
                            <label className="text-xs font-bold text-navy/40 dark:text-white/60 uppercase tracking-widest pl-2 block">Phone Number</label>
                            <input
                              type="text"
                              name="phone"
                              placeholder="+1 (000) 000 0000"
                              className="w-full bg-light/30 dark:bg-white/5 rounded-2xl py-5 px-6 border-2 border-light dark:border-white/10 focus:border-green hover:border-navy/10 dark:hover:border-white/20 text-navy dark:text-white placeholder:text-navy/20 dark:placeholder:text-white/30 outline-none transition-all focus:bg-white dark:focus:bg-navy focus:shadow-lg focus:-translate-y-1"
                            />
                          </div>

                          {/* Subject Field */}
                          <div className="space-y-3">
                            <label className="text-xs font-bold text-navy/40 dark:text-white/60 uppercase tracking-widest pl-2 block">Subject</label>
                            <input
                              type="text"
                              name="subject"
                              placeholder="e.g. Website Redesign"
                              className={`w-full bg-light/30 dark:bg-white/5 rounded-2xl py-5 px-6 border-2 focus:border-green hover:border-navy/10 dark:hover:border-white/20 text-navy dark:text-white placeholder:text-navy/20 dark:placeholder:text-white/30 outline-none transition-all focus:bg-white dark:focus:bg-navy focus:shadow-lg focus:-translate-y-1 ${errors.subject ? 'border-red-500' : 'border-light dark:border-white/10'}`}
                            />
                        ...
                        {/* Message Field */}
                        <div className="space-y-3">
                          <label className="text-xs font-bold text-navy/40 dark:text-white/60 uppercase tracking-widest pl-2 block">Project Brief</label>
                          <textarea
                            name="message"
                            rows={5}
                            placeholder="Describe your current store, your pain points, and your goals..."
                            className={`w-full bg-light/30 dark:bg-white/5 rounded-[28px] py-6 px-8 border-2 focus:border-green hover:border-navy/10 dark:hover:border-white/20 text-navy dark:text-white placeholder:text-navy/20 dark:placeholder:text-white/30 outline-none transition-all resize-none focus:bg-white dark:focus:bg-navy focus:shadow-lg focus:-translate-y-1 ${errors.message ? 'border-red-500' : 'border-light dark:border-white/10'}`}
                          />
                        ...
                        <div className="pt-4 space-y-6">
                          ...
                          >
                            <div className="absolute inset-0 bg-navy dark:bg-white/15 group-hover:bg-green dark:group-hover:bg-green transition-all duration-500" />
                      ...
                      <motion.div
                        ...
                        className="space-y-12"
                      >
                        <div className="text-center space-y-8 py-20 pb-10 border-b border-navy/5 dark:border-white/10">
                          ...
                          <div className="space-y-6">
                            <h3 className="text-4xl md:text-5xl lg:text-6xl font-bold text-navy dark:text-white tracking-tighter">Congratulations! Perfectly received.</h3>
                            <p className="text-navy/60 dark:text-white/70 text-xl max-w-lg mx-auto leading-relaxed">
                              Your message was successfully submitted. A confirmation message from <span className="font-bold text-navy dark:text-white">sheunhost@gmail.com</span> will be sent to you shortlyWe'm already reviewing your details. Let's make this project a success.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-10">
                          {[
                            ...
                            <div key={i} className="p-6 bg-light dark:bg-white/5 rounded-3xl space-y-4">
                              <div className="w-10 h-10 bg-white dark:bg-white/10 rounded-xl flex items-center justify-center text-green shadow-sm">
                                <step.icon size={20} />
                              </div>
                              <div className="space-y-1">
                                <p className="font-bold text-navy dark:text-white uppercase text-[10px] tracking-widest opacity-40">{step.title}</p>
                                <p className="text-xs text-navy/60 dark:text-white/60 font-medium leading-relaxed">{step.desc}</p>
                              </div>
                            </div>
                          ))}
                        </div>
                        ...
                        <div className="pt-6 text-center">
                          <button
                            ...
                            className="px-10 py-4 bg-navy dark:bg-white/10 text-white rounded-full font-bold text-sm tracking-widest uppercase hover:bg-green hover:text-navy transition-all"
                          >
                            New Message
                          </button>
                        </div>
      ...
      <ScrollReveal>
        <section className="py-24 bg-light dark:bg-navy overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-white/50 dark:bg-white/5 border border-navy/5 dark:border-white/10 rounded-[60px] overflow-hidden shadow-sm">
            
            {/* CTA Content */}
            <div className="p-16 md:p-24 space-y-12 bg-white dark:bg-navy-light flex flex-col justify-center">
              <div className="w-20 h-20 bg-green rounded-3xl flex items-center justify-center text-navy shadow-xl rotate-3">
                <Gift size={40} />
              </div>
              <div className="space-y-6">
                <h2 className="text-5xl md:text-7xl font-bold text-navy dark:text-white leading-none tracking-tighter">
                  Free store <br />
                  <span className="italic font-serif font-light text-navy/30 dark:text-white/40">video audit.</span>
                </h2>
                <p className="text-navy/50 dark:text-white/70 text-2xl font-serif italic leading-snug">
              ...
              <div className="flex flex-wrap gap-8">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 text-navy/40 dark:text-white/60 font-bold uppercase tracking-widest text-[10px]">
            ...
            {/* CTA Form */}
            <div className="p-16 md:p-24 bg-navy dark:bg-white/5 text-white relative">
                    ...
                    >
                      ...
                      <div className="space-y-6">
                        ...
                        <p className="text-white/60 text-lg leading-relaxed">
                          Your request was successfully submitted. A confirmation from <span className="font-bold text-white">sheunhost@gmail.com</span> will be sent to you shortlyWe'll have your video ready and sent to your inbox within 24-48 hours. Here's what's next:
                        </p>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto space-y-20">
              <div className="text-center space-y-6">
                <h2 className="text-5xl md:text-7xl font-bold text-navy dark:text-white tracking-tighter">Common Questions.</h2>
                <p className="text-navy/60 dark:text-white/70 text-xl font-serif italic leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
                {[
                  ...
                  <div key={i} className="space-y-4">
                    <h3 className="text-xl font-bold text-navy dark:text-white tracking-tight">{faq.q}</h3>
