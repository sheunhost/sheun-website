...
async function main() {
  for (let idx = 0; idx < files.length; idx++) {
    ...
    // Find where prose starts and first paragraph ends
    const proseRegex = /(<div className="prose prose-lg md:prose-xl max-w-none prose-headings:font-bold prose-headings:text-navy prose-p:text-navy\/80 prose-p:leading-relaxed font-sans">[\s\S]*?<\/p>)/;
