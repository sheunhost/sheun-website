export var servicesData = {
    ...
    "dropshipping": {
        ...
        faqs: [
            ...
            { q: "Will the store look like a generic dropshipping site?", a: "No. My primary goal is to build a brand. I use custom branding, edited images, and trustworthy layouts to hide the 'dropship' feel." },
            ...
            { q: "Can I integrate AliExpress reviews?", a: "Absolutely. I integrate apps like Loox or AliReviews to import real photo reviews for social proof." },
            { q: "Do you help with paid advertising?", a: "I focus strictly on the website development and conversion optimization, giving you the best possible foundation for your ads to succeed." }
        ],
    ...
    "migration": {
        ...
        faqs: [
            { q: "Will I lose my SEO rankings during the migration?", a: "No. By implementing strict 301 redirect mapping, we tell Google exactly where your old pages have moved. Your SEO rankings are preserved, ensuring no loss in organic traffic or search visibility." },
            { q: "What data actually transfers to Shopify?", a: "I migrate your entire product catalog (including descriptions, variants, and images), customer databases, order history, and blog posts. Your business history stays completely intact." },
            { q: "How long does the Shopify migration process take?", a: "A standard migration typically takes 1 to 2 weeks. This includes the initial data transfer, design matching, SEO mapping, and final quality assurance testing before going live." },
            { q: "Are there any technical requirements on my end?", a: "You simply need to provide administrative access to your current platform (e.g., WooCommerce, Etsy, Squarespace) and your domain registrar. I handle all the technical configuration from there." },
            { q: "Can my old design be replicated on Shopify?", a: "Yes. I can either match your existing design as closely as possible or use the migration as an opportunity to upgrade you to a faster, more modern Shopify theme." }
        ],
    ...
    "bug": {
        ...
        faqs: [
            { q: "How fast can you fix our issue?", a: "Depending on my current workload, emergency bugs are usually addressed within 24-48 hours." },
            { q: "Do you need access to our live store?", a: "Yes, you will need to grant me a collaborator account with access to Themes and Apps to diagnose the issue." },
            ...
            { q: "Can you fix apps made by third parties?", a: "I can fix conflicts between the app and your theme. If the app's internal server code is broken, I will need to contact the app developer." },
    ...
    "apps": {
        ...
        faqs: [
            ...
            { q: "Can you migrate my data between apps?", a: "Yes, such as moving reviews from Loox to Judge.us, or subscribers from Mailchimp to Klaviyo." },
