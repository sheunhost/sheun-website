...
import { ShieldCheck, Target, Activity, Users, Lightbulb, CheckCircle2, Eye, Cpu, Handshake, TrendingUp, Linkedin, Twitter } from "lucide-react";
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors group relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <p className="text-slate-400 text-sm mb-6 leading-relaxed">
                  Builds AI workflows, integrations, CRM automations, APIs, and robust backend systems.
                </p>
                <div className="flex items-center gap-3">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-8">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
            ...
            <Link
              ...
              className="px-8 py-4 rounded-full font-bold text-white bg-white/5 border border-white/10 hover:bg-white/10 transition-colors"
            >
              View Capabilities
            </Link>
          </div>
